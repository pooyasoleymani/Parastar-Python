...
class ServiceCatalogView(
 ...
 # permission_classes = [IsAuthenticated]
  ...
  def get(self, request, id=None):
    ...
    if id:
      ...
      try:
        ...
        queryset = ServiceCatalog.objects.get(id=id)
      ...
      read_serializer = ServiceCatalogSerializer(queryset)
      ...
      read_serializer = ServiceCatalogSerializer(queryset, many=True)
  ...
  def post(self, request):
    ...
    create_serializer = ServiceCatalogSerializer(data=request.data)
    ...
    if create_serializer.is_valid():
      ...
      read_serializer = ServiceCatalogSerializer(todo_item_object)
  ...
  def put(self, request, id=None):
    try:
      # Check if the todo item the user wants to update exists
      todo_item = ServiceCatalog.objects.get(id=id)
    ...
    update_serializer = ServiceCatalogSerializer(todo_item, data=request.data)
